...
- `{colors.body}` text with underline appearing on default — used in FAQ answers ("see [hello@ollama.com](mailto:)") and footer. <!-- synthetic-ok: Ollama's own public contact address, quoted from their marketing site copy, not customer data -->
