...
| — | Gmail Sync (C1–C5.4: OAuth, sender trust gate, discovery, 6 merchant parsers, connection UI + review queue) | ✅ **Complete** — C5.4 merged 2026-08-15 (PR #122) | PRs #104–#122, all merged. Same "grew outside the phase table" pattern §12 already flags for other unweighted work — not yet in §1/§2, security review still owed (see 08-15 changelog). C6 (Gmail Intelligence) design-only per D-16, sequenced post-GA per D-15 |
