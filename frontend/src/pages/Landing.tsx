...
const FAQ_ITEMS: [string, string][] = [
  ...
  ['Can I export my data?', "The Reports page exports a CSV of any month's category breakdown today, and your original uploaded statement files are always downloadable from Statement History. A full CSV export of your raw transaction list is the next thing being built and genuinely isn't available yet. In the meantime everything is viewable and filterable in-app across Transactions, Reports and Statement History. Your data is yours; the gap is a missing feature, not a lock-in."],
];
