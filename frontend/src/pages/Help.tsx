...
const ARTICLES: HelpArticle[] = [
  ...
  { category: 'Importing Statements', question: 'Which file formats are supported?', answer: 'CSV exports from your bank or card portal. Finora automatically detects common column-naming variants (e.g. "Debit (INR)" vs "Withdrawal Amt") across different banks.' },
        ...
        <div className="space-y-3 mb-10">
          {filtered.map((a) => (
            <div key={a.question} className="bg-[#12142a] border border-white/10 rounded-xl p-5">
              <span className="text-[10px] uppercase tracking-wide text-indigo-300 font-semibold">{a.category}</span>
