...
export function AppleSignInButton({ onCredential, onError }: AppleSignInButtonProps) {
  ...
  return (
    ...
    <button
      ...
      disabled={loading}
      className="w-full flex items-center justify-center gap-2 rounded-lg border border-gray-800 bg-black text-white py-2.5 text-sm font-medium disabled:opacity-50"
    >
