 ...
 * -- see V125), never from a raw provider payload. See {@link NotificationAdminDetailDto} for the
...
public record NotificationAdminDto(
     ...
     * {@code notifications.status} column comment (V123), but no code path in this codebase ever
